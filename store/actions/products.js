...
export const deleteProduct = productId => {
    return async dispatch => {
        const response = await fetch(`https://the-react-native-shopping-app.firebaseio.com/products/${productId}.json`, {
            method: 'DELETE'
        });
...
export const updateProduct = (id, title, imageUrl, description) => {
    return async dispatch => {
        const response = await fetch(`https://the-react-native-shopping-app.firebaseio.com/products/${id}.json`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json'
            },
